...
namespace :heroku_review_apps do
  ...
  task setup: :environment do
    ...
    ENV['FIXTURES'] = 'users,projects,tags,tracks,user_options' # Workaround ActiveRecord::InvalidForeignKey: PG::ForeignKeyViolation: ERROR: insert or update on table "tracks" violates foreign key constraint "fk_rails_xxxxx"
