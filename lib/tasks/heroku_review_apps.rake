...
namespace :heroku_review_apps do
  ...
  task setup: :environment do
    ...
    ENV['FIXTURES'] = 'users,tags,projects,tracks' # Workaround ActiveRecord::InvalidForeignKey: PG::ForeignKeyViolation: ERROR: insert or update on table "tracks" violates foreign key constraint "fk_rails_xxxxx"
